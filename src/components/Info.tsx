    ...
    return (
        <div className={styles.containerLeft}>
            ...
            <div className={styles.info}>
                <p>* O menor valor corresponde ao valor do curso à vista mencionado no site da escola em 03/2023. O maior valor está sujeito a taxas de financiamento. Atente-se às condições contratuais.</p>        
